...
echo 'Cloning lemonades device and vendor trees [1/6]'

rm -rf device/oneplus/lemonades && rm -rf vendor/oneplus/lemonades
git clone https://github.com/Spark-OS-Oneplus-SM8250/device_oneplus_lemonades device/oneplus/lemonades
git clone https://github.com/Spark-OS-Oneplus-SM8250/vendor_oneplus_lemonades vendor/oneplus/lemonades
