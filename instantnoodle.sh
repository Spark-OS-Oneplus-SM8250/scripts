...
echo 'Cloning instantnoodle device and vendor trees [1/6]'

rm -rf device/oneplus/instantnoodle && rm -rf vendor/oneplus/instantnoodle
git clone https://github.com/Spark-OS-Oneplus-SM8250/device_oneplus_instantnoodle device/oneplus/instantnoodle
git clone https://github.com/Spark-OS-Oneplus-SM8250/vendor_oneplus_instantnoodle vendor/oneplus/instantnoodle
