...
echo 'Cloning kebab device and vendor trees [1/6]'

rm -rf device/oneplus/kebab && rm -rf vendor/oneplus/kebab
git clone https://github.com/Spark-OS-Oneplus-SM8250/device_oneplus_kebab device/oneplus/kebab
git clone https://github.com/Spark-OS-Oneplus-SM8250/vendor_oneplus_kebab vendor/oneplus/kebab
